<div class="bg-white rounded-xl shadow-lg p-6 transition-transform hover:scale-[1.01] hover:shadow-2xl duration-200 border border-gray-100 relative overflow-hidden">
    ...
    <div class="flex flex-wrap gap-8 mb-2 text-sm text-gray-600">
    ...
    @if($complaint->complaintResponses->isNotEmpty())
        <div class="mt-4 mb-2 border-t pt-2 text-left">
    ...
    <div class="flex flex-col items-end ml-auto mt-2">
        <div class="text-xs text-gray-500 flex items-center gap-2 mt-3 self-end">
